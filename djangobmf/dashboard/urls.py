...
urlpatterns = patterns(
    ...
    url(
        r'^create/$', DashboardCreate.as_view(), name="dashboard_create",
    ),
    url(
        r'^(?P<pk>[0-9]+)/update/$', DashboardUpdate.as_view(), name="dashboard_update",
    ),
    url(
        r'^(?P<pk>[0-9]+)/delete/$', DashboardDelete.as_view(), name="dashboard_delete",
    ),
)
